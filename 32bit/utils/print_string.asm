...
print_string:             ; Print the string store in the EBX registry
	pusha
...
print_string_loop:        ; This is our main loop, it will iterate over our string and print the char
	...
	je print_string_end     ; Stop the loop
...
print_string_end:         ; End of the print_string function. Just some cleanup
	popa
	ret
